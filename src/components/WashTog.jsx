      ...
      <Page size="A4" style={styles.page}>
        ...
        >
          ...
          <View style={{ fontSize: 12, width: "30%" }}>
            ...
            >
              ...
              <Text
                style={{ color: "#23940A", fontSize: 16, fontFamily: "inter" }}
              >
        ...
        >
          ...
          <Text style={styles.terms}>
            1. All services will be performed in accordance with the client's
            specified requirements and instructions.
          </Text>
          <Text style={styles.terms}>
            2. The cleaning provider will take reasonable care in performing the
            services to avoid causing damage to property.
          </Text>
          <Text style={styles.terms}>
            3. The client is responsible for removing any personal belongings,
            valuables, or fragile items before cleaning.
          </Text>
          <Text style={styles.terms}>
            4. The client must provide clear instructions regarding areas to be
            cleaned or avoided.
          </Text>
        </View>
