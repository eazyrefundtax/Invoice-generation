            ...
            <View style={{ flexDirection: "row", alignItems: "center", marginTop: 5 }}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View
                        ...
                        <Text style={{ fontSize: 9 }}>
                            <Text>PAN Number:</Text> AAHCE8524F
                        </Text>
                    </View>
                </View>
            </View>
            ...
            <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                <View>
                    ...
                    <View style={{ display: "flex", flexDirection: "row", gap: 20, fontSize: 9, }}>
                        ...
                        <View>
                            <Text style={{ marginTop: 5, }}>ER5 TAXATION PRIVATE LIMITED</Text>
                            <Text style={{ marginTop: 5, }}>HDFC0002391</Text>
                            <Text style={{ marginTop: 5, }}>99997386670536</Text>
